...
Bullets.prototype.playerShoot = function( x,y, direction ) {
  var bullet = this.getFirstExists(false);
  if (bullet) {
    var vec = angleToVector( direction );
    bullet.reset(x + (vec.x*50), y + (vec.y*50));
    ...
    bullet.tween=game.add.tween(bullet).to( { alpha:0 }, /*duration*/200,
      Phaser.Easing.Linear.None , /*autostart*/true, /*delay*/1200, /*repeat*/0, /*yoyo*/false)
